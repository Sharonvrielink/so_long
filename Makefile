...
#################################Project_files##################################
SRC_DIR			:=	./src
SRC_FILES		:=	so_long.c sprite_printer.c sprite_load_textures_images.c\
					map_reader.c valid_map_checker.c valid_path_checker.c error.c\
					move_player.c map_printer.c copy_grid.c main.c
OBJ_DIR			:=	./obj
